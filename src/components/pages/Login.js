  ...
  return (
    <div className="esg-flex esg-flex-col esg-items-center esg-justify-center esg-min-h-screen esg-bg-gray-100">
      <div className="esg-p-8 esg-bg-white esg-rounded-lg esg-shadow-md esg-w-full esg-max-w-md">
        <h2 className="esg-text-2xl esg-font-bold esg-mb-6 esg-text-center esg-text-gray-800">Login</h2>
        {error && <p className="esg-text-red-500 esg-text-center esg-mb-4">{error}</p>}
        <form onSubmit={handleSubmit} className="esg-space-y-4">
          <div>
            <label className="esg-block esg-text-gray-700 esg-text-sm esg-font-bold esg-mb-2" htmlFor="username">
              Username:
            </label>
            <input
              type="text"
          ...
          <div>
            <label className="esg-block esg-text-gray-700 esg-text-sm esg-font-bold esg-mb-2" htmlFor="password">
              Password:
            </label>
            <input
              type="password"
