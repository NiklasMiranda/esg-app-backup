...
function ExtendedModule({ currentYear }) {
  ...
  const [isEDataExpanded, setIsEDataExpanded] = useState(true);
  const [isSDataExpanded, setIsSDataExpanded] = useState(true);
  const [isGDataExpanded, setIsGDataExpanded] = useState(true);
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="esg-mb-8 esg-border esg-border-gray-200 esg-rounded-lg esg-shadow-sm">
          <div className="esg-p-4 esg-cursor-pointer esg-flex esg-justify-between esg-items-center esg-bg-gray-50 hover:esg-bg-gray-100 esg-rounded-t-lg" onClick={() => setIsGeneralInfoExpanded(!isGeneralInfoExpanded)}>
            <h3 className="esg-text-xl esg-font-semibold esg-text-gray-700">1. Generelle oplysninger (C1 & C2)</h3>
        ...
        {/* E-data */}
        <div className="esg-mb-8 esg-border esg-border-gray-200 esg-rounded-lg esg-shadow-sm">
          <div className="esg-p-4 esg-cursor-pointer esg-flex esg-justify-between esg-items-center esg-bg-gray-50 hover:esg-bg-gray-100 esg-rounded-t-lg" onClick={() => setIsEDataExpanded(!isEDataExpanded)}>
            <h3 className="esg-text-xl esg-font-semibold esg-text-gray-700">2. E-data</h3>
            <FaChevronDown className={`esg-ml-auto esg-transition-transform esg-duration-300 ${isEDataExpanded ? 'esg-rotate-180' : ''}`} />
          </div>
          <div className={`esg-transition-[max-height,opacity] esg-duration-500 esg-ease-in-out esg-overflow-hidden ${isEDataExpanded ? 'esg-max-h-[5000px] esg-opacity-100' : 'esg-max-h-0 esg-opacity-0'}`}>
            <div className="esg-p-4">
              <div className="esg-grid esg-grid-cols-1 md:esg-grid-cols-2 esg-gap-4">
        ...
        {/* S-data */}
        <div className="esg-mb-8 esg-border esg-border-gray-200 esg-rounded-lg esg-shadow-sm">
          <div className="esg-p-4 esg-cursor-pointer esg-flex esg-justify-between esg-items-center esg-bg-gray-50 hover:esg-bg-gray-100 esg-rounded-t-lg" onClick={() => setIsSDataExpanded(!isSDataExpanded)}>
            <h3 className="esg-text-xl esg-font-semibold esg-text-gray-700">3. S-data</h3>
            <FaChevronDown className={`esg-ml-auto esg-transition-transform esg-duration-300 ${isSDataExpanded ? 'esg-rotate-180' : ''}`} />
          </div>
          <div className={`esg-transition-[max-height,opacity] esg-duration-500 esg-ease-in-out esg-overflow-hidden ${isSDataExpanded ? 'esg-max-h-[5000px] esg-opacity-100' : 'esg-max-h-0 esg-opacity-0'}`}>
            <div className="esg-p-4">
              <div className="esg-grid esg-grid-cols-1 md:esg-grid-cols-2 esg-gap-4">
                {/* C5 */}
                <div>
        ...
        {/* G-data */}
        <div className="esg-mb-8 esg-border esg-border-gray-200 esg-rounded-lg esg-shadow-sm">
          <div className="esg-p-4 esg-cursor-pointer esg-flex esg-justify-between esg-items-center esg-bg-gray-50 hover:esg-bg-gray-100 esg-rounded-t-lg" onClick={() => setIsGDataExpanded(!isGDataExpanded)}>
            <h3 className="esg-text-xl esg-font-semibold esg-text-gray-700">4. G-data</h3>
            <FaChevronDown className={`esg-ml-auto esg-transition-transform esg-duration-300 ${isGDataExpanded ? 'esg-rotate-180' : ''}`} />
          </div>
          <div className={`esg-transition-[max-height,opacity] esg-duration-500 esg-ease-in-out esg-overflow-hidden ${isGDataExpanded ? 'esg-max-h-[5000px] esg-opacity-100' : 'esg-max-h-0 esg-opacity-0'}`}>
            <div className="esg-p-4">
              <div className="esg-grid esg-grid-cols-1 md:esg-grid-cols-2 esg-gap-4">
                {/* C8 */}
                <div className="md:esg-col-span-2">
