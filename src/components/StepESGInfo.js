...
function StepESGInfo({ onNext }) {
  return (
    <div className="esg-p-4">
      <h1 className="esg-text-3xl esg-font-bold esg-mb-8">Matrix-spørgsmål – fra væsentlighed til konkret vurdering</h1>

      <div className="esg-bg-white esg-p-6 esg-rounded-lg esg-shadow-md">
        <p className="esg-text-gray-700">
          Efter at virksomheden har fastlagt sin væsentlighed og vægtning i ESG-beregneren, begynder næste trin: matrix-spørgsmålene.
          ...
          Matrix-spørgsmålene fungerer som konkrete indikatorer, 
          ...
          De samlede point fra matrixen vægtes derefter i forhold til den tidligere fastsatte væsentlighed 
          ...
          Målet med matrix-spørgsmålene er at gøre ESG-arbejdet målbart, ensartet og udviklingsorienteret.
          Når resultaterne visualiseres i ESG-matrixen (impact vs. finansiel væsentlighed), 
      ...
      <div className="esg-flex esg-justify-end esg-mt-8">
        <button onClick={onNext} className="btn-primary">Til matrix-spørgsmålene</button>
      </div>
    </div>
  );
}
