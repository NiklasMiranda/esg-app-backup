...
function CompanyFigures({ currentYear }) {
  ...
  const [isEnergyConsumptionExpanded, setIsEnergyConsumptionExpanded] =
  ...
  const [isResourcesWasteExpanded, setIsResourcesWasteExpanded] =
    useState(true); // New state
    ...
    const fetchCompanyBasismodulData = async () => {
      ...
      try {
        ...
        if (error.response && error.response.status === 404) {
          console.log(
            `No existing Basismodul data for company ${COMPANY_ID} for year ${currentYear}. Form already reset.`,
          );
        } else {
  ...
  const removeNaceCode = (index) => {
    const newNaceCodes = formData.nace_sector_codes.filter(
      (_, i) => i !== index,
    );
    setFormData((prevData) => ({
      ...prevData,
    ...
    <div className="esg-p-6 esg-bg-white esg-rounded-lg esg-shadow-md">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="esg-mb-8 esg-border esg-border-gray-200 esg-rounded-lg esg-shadow-sm">
          ...
          >
            <h3 className="esg-text-xl esg-font-semibold esg-text-gray-700">
              1. Generelle oplysninger: Grundlag for udarbejdelse (B1)
            </h3>
            <FaChevronDown
              className={`esg-ml-auto esg-transition-transform esg-duration-300 ${isGeneralInfoExpanded ? 'esg-rotate-180' : ''}`}
            />
          </div>
          <div
            className={`esg-transition-[max-height,opacity] esg-duration-500 esg-ease-in-out esg-overflow-hidden ${isGeneralInfoExpanded ? 'esg-max-h-[5000px] esg-opacity-100' : 'esg-max-h-0 esg-opacity-0'}`}
          >
            <div className="esg-p-4">
              <div className="esg-grid esg-grid-cols-1 md:esg-grid-cols-3 esg-gap-4">
                ...
                <div>
                  <label
                    htmlFor="legal_form"
                    className="esg-block esg-text-gray-700 esg-text-md esg-font-bold esg-mb-2"
                  >
                ...
                <div>
                  {' '}
                  {/* NACE codes block now acts as a single column */}
                  ...
                  {formData.nace_sector_codes.map((code, index) => (
                    <div
                      key={index}
                      className="esg-flex esg-items-center esg-mb-2"
                    >
                      <input
                        type="text"
                        ...
                        value={code}
                        onChange={(e) =>
                          handleNaceCodeChange(index, e.target.value)
                        }
                ...
                <div>
                  {' '}
                  {/* Removed md:esg-col-span-3 */}
                  <label
                    htmlFor="asset_locations"
                    className="esg-block esg-text-gray-700 esg-text-md esg-font-bold esg-mb-2"
                  >
                ...
                <div>
                  ...
                  {/* Removed md:esg-col-span-3 */}
                  <label
                    htmlFor="confidentiality_exclusions"
                    className="esg-block esg-text-gray-700 esg-text-md esg-font-bold esg-mb-2"
                  >
                ...
                <div>
                  ...
                  {/* Removed md:esg-col-span-3 */}
                  <label
                    htmlFor="esg_certificate_description"
                    className="esg-block esg-text-gray-700 esg-text-md esg-font-bold esg-mb-2"
                  >
                    Kort beskrivelse af din virksomheds eventuelle
                    ESG-certifikat eller miljømærker (valgfri):
                  </label>
                  <textarea
        ...
        <div className="esg-mb-8 esg-border esg-border-gray-200 esg-rounded-lg esg-shadow-sm">
          ...
          >
            <h3 className="esg-text-xl esg-font-semibold esg-text-gray-700">
              2. Generelle oplysninger: Indsatser, politikker og fremtidige
              initiativer (B2)
            </h3>
            <FaChevronDown
              className={`esg-ml-auto esg-transition-transform esg-duration-300 ${isInitiativesExpanded ? 'esg-rotate-180' : ''}`}
            />
          </div>
          <div
            className={`esg-transition-[max-height,opacity] esg-duration-500 esg-ease-in-out esg-overflow-hidden ${isInitiativesExpanded ? 'esg-max-h-[5000px] esg-opacity-100' : 'esg-max-h-0 esg-opacity-0'}`}
          >
            <div className="esg-p-4">
              <div className="esg-flex esg-items-center esg-mb-4">
                ...
                />
                <label
                  htmlFor="has_initiatives"
                  className="esg-text-gray-700 esg-text-md esg-font-bold"
                >
                  Har din virksomhed allerede konkrete indsatser, politikker
                  eller initiativer, der understøtter omstilling til en mere
                  bæredygtig økonomi? (valgfri)
                </label>
              </div>
            </div>
          </div>
        ...
        <div className="esg-mb-8 esg-border esg-border-gray-200 esg-rounded-lg esg-shadow-sm">
          <div
            className="esg-p-4 esg-cursor-pointer esg-flex esg-justify-between esg-items-center esg-bg-gray-50 hover:esg-bg-gray-100 esg-rounded-t-lg"
            onClick={() =>
              setIsEnergyConsumptionExpanded(!isEnergyConsumptionExpanded)
            }
          >
            <h3 className="esg-text-xl esg-font-semibold esg-text-gray-700">
              3. E-Data: Energiforbrug (B3)
            </h3>
            <FaChevronDown
              className={`esg-ml-auto esg-transition-transform esg-duration-300 ${isEnergyConsumptionExpanded ? 'esg-rotate-180' : ''}`}
            />
          </div>
          <div
            className={`esg-transition-[max-height,opacity] esg-duration-500 esg-ease-in-out esg-overflow-hidden ${isEnergyConsumptionExpanded ? 'esg-max-h-[5000px] esg-opacity-100' : 'esg-max-h-0 esg-opacity-0'}`}
          >
            <div className="esg-p-4">
              <div className="esg-grid esg-grid-cols-1 md:esg-grid-cols-2 lg:esg-grid-cols-4 esg-gap-4">
                <div>
                  <label
                    htmlFor="electricity_renewable"
                    className="esg-block esg-text-gray-700 esg-text-md esg-font-bold esg-mb-2"
                  >
                ...
                <div>
                  <label
                    htmlFor="electricity_non_renewable"
                    className="esg-block esg-text-gray-700 esg-text-md esg-font-bold esg-mb-2"
                  >
        ...
        <div className="esg-mb-8 esg-border esg-border-gray-200 esg-rounded-lg esg-shadow-sm">
          <div
            className="esg-p-4 esg-cursor-pointer esg-flex esg-justify-between esg-items-center esg-bg-gray-50 hover:esg-bg-gray-100 esg-rounded-t-lg"
            onClick={() => setIsCo2EmissionsExpanded(!isCo2EmissionsExpanded)}
          >
            <h3 className="esg-text-xl esg-font-semibold esg-text-gray-700">
              4. E-Data: CO₂e-udledninger (B3)
            </h3>
            <FaChevronDown
              className={`esg-ml-auto esg-transition-transform esg-duration-300 ${isCo2EmissionsExpanded ? 'esg-rotate-180' : ''}`}
            />
          </div>
          <div
            className={`esg-transition-[max-height,opacity] esg-duration-500 esg-ease-in-out esg-overflow-hidden ${isCo2EmissionsExpanded ? 'esg-max-h-[5000px] esg-opacity-100' : 'esg-max-h-0 esg-opacity-0'}`}
          >
            <div className="esg-p-4">
              <div className="esg-grid esg-grid-cols-1 md:esg-grid-cols-2 lg:esg-grid-cols-4 esg-gap-4">
                <div>
                  <label
                    htmlFor="scope1_emissions"
                    className="esg-block esg-text-gray-700 esg-text-md esg-font-bold esg-mb-2"
                  >
        ...
        <div className="esg-mb-8 esg-border esg-border-gray-200 esg-rounded-lg esg-shadow-sm">
          <div
            className="esg-p-4 esg-cursor-pointer esg-flex esg-justify-between esg-items-center esg-bg-gray-50 hover:esg-bg-gray-100 esg-rounded-t-lg"
            onClick={() => setIsPollutionExpanded(!isPollutionExpanded)}
          >
            <h3 className="esg-text-xl esg-font-semibold esg-text-gray-700">
              5. E-Data: Forurening af luft, vand og jord (B4)
            </h3>
            <FaChevronDown
              className={`esg-ml-auto esg-transition-transform esg-duration-300 ${isPollutionExpanded ? 'esg-rotate-180' : ''}`}
            />
          </div>
          <div
            className={`esg-transition-[max-height,opacity] esg-duration-500 esg-ease-in-out esg-overflow-hidden ${isPollutionExpanded ? 'esg-max-h-[5000px] esg-opacity-100' : 'esg-max-h-0 esg-opacity-0'}`}
          >
            <div className="esg-p-4">
              <div className="esg-grid esg-grid-cols-1 esg-gap-4">
                <div className="md:esg-col-span-1">
                  <label
                    htmlFor="pollution_reporting"
                    className="esg-block esg-text-gray-700 esg-text-md esg-font-bold esg-mb-2"
                  >
                    Rapportering om forurening (Kun et oplysningskrav, hvis din
                    virksomhed i forvejen rapporterer om forurening som følge af
                    lovkrav eller på frivillig basis):
                  </label>
                  <textarea
        ...
        <div className="esg-mb-8 esg-border esg-border-gray-200 esg-rounded-lg esg-shadow-sm">
          <div
            className="esg-p-4 esg-cursor-pointer esg-flex esg-justify-between esg-items-center esg-bg-gray-50 hover:esg-bg-gray-100 esg-rounded-t-lg"
            onClick={() => setIsBiodiversityExpanded(!isBiodiversityExpanded)}
          >
            <h3 className="esg-text-xl esg-font-semibold esg-text-gray-700">
              6. E-Data: Biodiversitet (B5)
            </h3>
            <FaChevronDown
              className={`esg-ml-auto esg-transition-transform esg-duration-300 ${isBiodiversityExpanded ? 'esg-rotate-180' : ''}`}
            />
          </div>
          <div
            className={`esg-transition-[max-height,opacity] esg-duration-500 esg-ease-in-out esg-overflow-hidden ${isBiodiversityExpanded ? 'esg-max-h-[5000px] esg-opacity-100' : 'esg-max-h-0 esg-opacity-0'}`}
          >
            <div className="esg-p-4">
              <div className="esg-grid esg-grid-cols-1 md:esg-grid-cols-2 esg-gap-4">
                <div>
                  <label
                    htmlFor="biodiversity_sensitive_areas"
                    className="esg-block esg-text-gray-700 esg-text-md esg-font-bold esg-mb-2"
                  >
                    Opgørelse af virksomhedens områder i nærheden af eller i
                    'biodiversitetsfølsomme områder’ (obligatorisk hvis
                    relevant):
                  </label>
                  <textarea
        ...
        <div className="esg-mb-8 esg-border esg-border-gray-200 esg-rounded-lg esg-shadow-sm">
          ...
          >
            ...
            <FaChevronDown
              className={`esg-ml-auto esg-transition-transform esg-duration-300 ${isWaterExpanded ? 'esg-rotate-180' : ''}`}
            />
          </div>
          <div
            className={`esg-transition-[max-height,opacity] esg-duration-500 esg-ease-in-out esg-overflow-hidden ${isWaterExpanded ? 'esg-max-h-[5000px] esg-opacity-100' : 'esg-max-h-0 esg-opacity-0'}`}
          >
            <div className="esg-p-4">
              <div className="esg-grid esg-grid-cols-1 md:esg-grid-cols-2 esg-gap-4">
                <div>
                  <label
                    htmlFor="water_withdrawal"
                    className="esg-block esg-text-gray-700 esg-text-md esg-font-bold esg-mb-2"
                  >
                    Udtagning af vand:
                  </label>
        ...
        <div className="esg-mb-8 esg-border esg-border-gray-200 esg-rounded-lg esg-shadow-sm">
          <div
            className="esg-p-4 esg-cursor-pointer esg-flex esg-justify-between esg-items-center esg-bg-gray-50 hover:esg-bg-gray-100 esg-rounded-t-lg"
            onClick={() =>
              setIsResourcesWasteExpanded(!isResourcesWasteExpanded)
            }
          >
            <h3 className="esg-text-xl esg-font-semibold esg-text-gray-700">
              8. E-Data: Ressourceforbrug, cirkulær økonomi og affaldshåndtering
              (B7)
            </h3>
            <FaChevronDown
              className={`esg-ml-auto esg-transition-transform esg-duration-300 ${isResourcesWasteExpanded ? 'esg-rotate-180' : ''}`}
            />
          </div>
          <div
            className={`esg-transition-[max-height,opacity] esg-duration-500 esg-ease-in-out esg-overflow-hidden ${isResourcesWasteExpanded ? 'esg-max-h-[5000px] esg-opacity-100' : 'esg-max-h-0 esg-opacity-0'}`}
          >
            <div className="esg-p-4">
              <div className="esg-grid esg-grid-cols-1 md:esg-grid-cols-3 esg-gap-4">
                <div className="esg-flex esg-items-center esg-mb-4 md:esg-col-span-3">
                  ...
                  />
                  <label
                    htmlFor="uses_circular_economy_principles"
                    className="esg-text-gray-700 esg-text-md esg-font-bold"
                  >
                ...
                {formData.uses_circular_economy_principles && (
                  <div className="md:esg-col-span-3 esg-mb-4">
                    <label
                      htmlFor="circular_economy_description"
                      className="esg-block esg-text-gray-700 esg-text-md esg-font-bold esg-mb-2"
                    >
                      Beskrivelse af, hvordan der arbejdes med principper fra
                      cirkulær økonomi:
                    </label>
                    <textarea
                ...
                <div>
                  <label
                    htmlFor="total_waste_non_hazardous"
                    className="esg-block esg-text-gray-700 esg-text-md esg-font-bold esg-mb-2"
                  >
                ...
                <div>
                  <label
                    htmlFor="waste_recycled"
                    className="esg-block esg-text-gray-700 esg-text-md esg-font-bold esg-mb-2"
                  >
                    Total mængde affald, der sendes til genbrug eller
                    genanvendelse:
                  </label>
                  <input
                    type="number"
                ...
                <div className="md:esg-col-span-3">
                  <label
                    htmlFor="mass_flow_materials"
                    className="esg-block esg-text-gray-700 esg-text-md esg-font-bold esg-mb-2"
                  >
                    Årlige masse-flow for virksomhedens centrale materialer
        ...
        <div className="esg-mb-8 esg-border esg-border-gray-200 esg-rounded-lg esg-shadow-sm">
          ...
          >
            <h3 className="esg-text-xl esg-font-semibold esg-text-gray-700">
              9. S-Data: Egen arbejdsstyrke (B8)
            </h3>
            <FaChevronDown
              className={`esg-ml-auto esg-transition-transform esg-duration-300 ${isWorkforceExpanded ? 'esg-rotate-180' : ''}`}
            />
          </div>
          <div
            className={`esg-transition-[max-height,opacity] esg-duration-500 esg-ease-in-out esg-overflow-hidden ${isWorkforceExpanded ? 'esg-max-h-[5000px] esg-opacity-100' : 'esg-max-h-0 esg-opacity-0'}`}
          >
            <div className="esg-p-4">
              <div className="esg-grid esg-grid-cols-1 md:esg-grid-cols-3 esg-gap-4">
                <div>
                ...
                <div>
                  <label
                    htmlFor="employee_turnover"
                    className="esg-block esg-text-gray-700 esg-text-md esg-font-bold esg-mb-2"
                  >
                    Medarbejderomsætning (oplyses kun ved mere end 50 ansatte,
                    valgfri):
                  </label>
                  <input
                    type="number"
                ...
                <div className="md:esg-col-span-3">
                  <label
                    htmlFor="employees_abroad"
                    className="esg-block esg-text-gray-700 esg-text-md esg-font-bold esg-mb-2"
                  >
                    Ansættelseskontrakter i andre lande udover Danmark
                    (obligatorisk hvis relevant):
                  </label>
                  <textarea
                    id="employees_abroad"
        ...
        <div className="esg-mb-8 esg-border esg-border-gray-200 esg-rounded-lg esg-shadow-sm">
          <div
            className="esg-p-4 esg-cursor-pointer esg-flex esg-justify-between esg-items-center esg-bg-gray-50 hover:esg-bg-gray-100 esg-rounded-t-lg"
            onClick={() => setIsHealthSafetyExpanded(!isHealthSafetyExpanded)}
          >
            <h3 className="esg-text-xl esg-font-semibold esg-text-gray-700">
              10. S-Data: Sundhed og sikkerhed (B9)
            </h3>
            <FaChevronDown
              className={`esg-ml-auto esg-transition-transform esg-duration-300 ${isHealthSafetyExpanded ? 'esg-rotate-180' : ''}`}
            />
          </div>
          <div
            className={`esg-transition-[max-height,opacity] esg-duration-500 esg-ease-in-out esg-overflow-hidden ${isHealthSafetyExpanded ? 'esg-max-h-[5000px] esg-opacity-100' : 'esg-max-h-0 esg-opacity-0'}`}
          >
            <div className="esg-p-4">
              <div className="esg-grid esg-grid-cols-1 md:esg-grid-cols-2 esg-gap-4">
                <div>
                  <label
                    htmlFor="work_accidents"
                    className="esg-block esg-text-gray-700 esg-text-md esg-font-bold esg-mb-2"
                  >
        ...
        <div className="esg-mb-8 esg-border esg-border-gray-200 esg-rounded-lg esg-shadow-sm">
          <div
            className="esg-p-4 esg-cursor-pointer esg-flex esg-justify-between esg-items-center esg-bg-gray-50 hover:esg-bg-gray-100 esg-rounded-t-lg"
            onClick={() => setIsCompensationExpanded(!isCompensationExpanded)}
          >
            <h3 className="esg-text-xl esg-font-semibold esg-text-gray-700">
              11. S-Data: Vederlag, overenskomster og uddannelse (B10)
            </h3>
            <FaChevronDown
              className={`esg-ml-auto esg-transition-transform esg-duration-300 ${isCompensationExpanded ? 'esg-rotate-180' : ''}`}
            />
          </div>
          <div
            className={`esg-transition-[max-height,opacity] esg-duration-500 esg-ease-in-out esg-overflow-hidden ${isCompensationExpanded ? 'esg-max-h-[5000px] esg-opacity-100' : 'esg-max-h-0 esg-opacity-0'}`}
          >
            <div className="esg-p-4">
              <div className="esg-grid esg-grid-cols-1 md:esg-grid-cols-2 lg:esg-grid-cols-4 esg-gap-4">
                <div>
                  <label
                    htmlFor="salary_below_minimum"
                    className="esg-block esg-text-gray-700 esg-text-md esg-font-bold esg-mb-2"
                  >
                ...
                <div>
                  <label
                    htmlFor="gender_pay_gap"
                    className="esg-block esg-text-gray-700 esg-text-md esg-font-bold esg-mb-2"
                  >
                    Lønforskel mellem mandlige og kvindelige ansatte (oplyses
                    kun ved over 150 ansatte, valgfri):
                  </label>
                  <input
                    type="number"
                    id="gender_pay_gap"
                ...
                <div>
                  <label
                    htmlFor="collective_bargaining_coverage"
                    className="esg-block esg-text-gray-700 esg-text-md esg-font-bold esg-mb-2"
                  >
                    Procentvis ansatte, der er dækket af en kollektiv
                    overenskomst:
                  </label>
                  <input
                    type="number"
        ...
        <div className="esg-mb-8 esg-border esg-border-gray-200 esg-rounded-lg esg-shadow-sm">
          ...
          >
            <h3 className="esg-text-xl esg-font-semibold esg-text-gray-700">
              12. G-Data: Virksomhedsledelse (B11)
            </h3>
            <FaChevronDown
              className={`esg-ml-auto esg-transition-transform esg-duration-300 ${isGovernanceExpanded ? 'esg-rotate-180' : ''}`}
            />
          </div>
          <div
            className={`esg-transition-[max-height,opacity] esg-duration-500 esg-ease-in-out esg-overflow-hidden ${isGovernanceExpanded ? 'esg-max-h-[5000px] esg-opacity-100' : 'esg-max-h-0 esg-opacity-0'}`}
          >
            <div className="esg-p-4">
              <div className="esg-grid esg-grid-cols-1 esg-gap-4">
                <div>
                  <label
                    htmlFor="corruption_bribery_cases"
                    className="esg-block esg-text-gray-700 esg-text-md esg-font-bold esg-mb-2"
                  >
                    Antal domme og bøder i relation til korruption & bestikkelse
                    (obligatorisk hvis relevant):
                  </label>
                  <input
                    type="number"
