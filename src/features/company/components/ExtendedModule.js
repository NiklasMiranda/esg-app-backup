...
function ExtendedModule({ currentYear }) {
  ...
  useEffect(() => {
    const fetchCompanyExtendedModulData = async () => {
      ...
      setFormData({
        ...
        exposure_vulnerability: '',
        climate_risks_time_horizon: '',
        climate_adaptation: null,
        financial_impact_climate_risks: '',
        gender_management_ratio: '',
        independent_workers: '',
        temporary_workers: '',
        code_of_conduct_hr_policy: null,
        grievance_mechanism: null,
        confirmed_hr_incidents_own_workforce: '',
        confirmed_hr_incidents_value_chain: '',
        revenue_selected_sectors: '',
        eu_benchmarks_exceedance: null,
        gender_top_management_ratio: '',
      });
      ...
      try {
        ...
        if (error.response && error.response.status === 404) {
          console.log(
            `No existing Extended Module data for company ${COMPANY_ID} for year ${currentYear}. Form already reset.`,
          );
        } else {
  ...
  return (
    <div className="esg-p-6 esg-bg-white esg-rounded-lg esg-shadow-md esg-min-h-screen">
      <h2 className="esg-text-2xl esg-font-bold esg-mb-6 esg-text-gray-800">
        Udvidet modul
      </h2>
      <form onSubmit={handleSubmit}>
        ...
        <div className="esg-mb-8 esg-border esg-border-gray-200 esg-rounded-lg esg-shadow-sm">
          <div
            className="esg-p-4 esg-cursor-pointer esg-flex esg-justify-between esg-items-center esg-bg-gray-50 hover:esg-bg-gray-100 esg-rounded-t-lg"
            onClick={() => setIsCategory1Expanded(!isCategory1Expanded)}
          >
            <h3 className="esg-text-xl esg-font-semibold esg-text-gray-700">
              1. Generelle oplysninger: Strategi: Forretningsmodel og
              bæredygtighedsrelaterede initiativer (C1)
            </h3>
            <FaChevronDown
              className={`esg-ml-auto esg-transition-transform esg-duration-300 ${isCategory1Expanded ? 'esg-rotate-180' : ''}`}
            />
          </div>
          <div
            className={`esg-transition-[max-height,opacity] esg-duration-500 esg-ease-in-out esg-overflow-hidden ${isCategory1Expanded ? 'esg-max-h-[5000px] esg-opacity-100' : 'esg-max-h-0 esg-opacity-0'}`}
          >
            <div className="esg-p-4">
              <div className="esg-grid esg-grid-cols-1 md:esg-grid-cols-2 lg:esg-grid-cols-4 esg-gap-4">
                <div>
                  <label
                    htmlFor="products_services_groups"
                    className="esg-block esg-text-gray-700 esg-text-lg esg-font-bold esg-mb-2"
                  >
                ...
                <div>
                  <label
                    htmlFor="business_relations"
                    className="esg-block esg-text-gray-700lg esg-font-bold esg-mb-2"
                  >
                ...
                <div>
                  <label
                    htmlFor="strategy_sustainability_elements"
                    className="esg-block esg-text-gray-700lg esg-font-bold esg-mb-2"
                  >
                    Centrale elementer fra virksomhedens strategi, der er
                    relateret til/påvirker bæredygtighedsspørgsmål (obligatorisk
                    hvis relevant):
                  </label>
                  <textarea
        ...
        <div className="esg-mb-8 esg-border esg-border-gray-200 esg-rounded-lg esg-shadow-sm">
          <div
            className="esg-p-4 esg-cursor-pointer esg-flex esg-justify-between esg-items-center esg-bg-gray-50 hover:esg-bg-gray-100 esg-rounded-t-lg"
            onClick={() => setIsCategory2Expanded(!isCategory2Expanded)}
          >
            <h3 className="esg-text-xl esg-font-semibold esg-text-gray-700">
              2. Generelle oplysninger: Beskrivelse af indsatser, politikker og
              fremtidige initiativer for omstilling til en mere bæredygtig
              økonomi (C2)
            </h3>
            <FaChevronDown
              className={`esg-ml-auto esg-transition-transform esg-duration-300 ${isCategory2Expanded ? 'esg-rotate-180' : ''}`}
            />
          </div>
          <div
            className={`esg-transition-[max-height,opacity] esg-duration-500 esg-ease-in-out esg-overflow-hidden ${isCategory2Expanded ? 'esg-max-h-[5000px] esg-opacity-100' : 'esg-max-h-0 esg-opacity-0'}`}
          >
            <div className="esg-p-4">
              <div className="esg-grid esg-grid-cols-1 md:esg-grid-cols-3 esg-gap-4">
                <div>
                  <label
                    htmlFor="existing_practices_policies"
                    className="esg-block esg-text-gray-700lg esg-font-bold esg-mb-2"
                  >
                    Beskrivelse af eksisterende praksisser/politikker/handlinger
                ...
                <div>
                  <label
                    htmlFor="future_initiatives_targets"
                    className="esg-block esg-text-gray-700lg esg-font-bold esg-mb-2"
                  >
                    Beskrivelse af fremtidige initiativer/målsætninger
                    (obligatorisk hvis relevant):
                  </label>
                  <textarea
                ...
                <div>
                  <label
                    htmlFor="highest_management_level"
                    className="esg-block esg-text-gray-700lg esg-font-bold esg-mb-2"
                  >
                    Angivelse af højeste ledelsesniveau i virksomheden, der er
                    ansvarlig for implementering (obligatorisk hvis relevant):
                  </label>
                  <input
                    type="text"
        ...
        <div className="esg-mb-8 esg-border esg-border-gray-200 esg-rounded-lg esg-shadow-sm">
          <div
            className="esg-p-4 esg-cursor-pointer esg-flex esg-justify-between esg-items-center esg-bg-gray-50 hover:esg-bg-gray-100 esg-rounded-t-lg"
            onClick={() => setIsCategory3Expanded(!isCategory3Expanded)}
          >
            <h3 className="esg-text-xl esg-font-semibold esg-text-gray-700">
              3. E-data: Vurdér, om Scope 3 CO₂e-udledning er relevant at oplyse
              om for netop din virksomhed
            </h3>
            <FaChevronDown
              className={`esg-ml-auto esg-transition-transform esg-duration-300 ${isCategory3Expanded ? 'esg-rotate-180' : ''}`}
            />
          </div>
          <div
            className={`esg-transition-[max-height,opacity] esg-duration-500 esg-ease-in-out esg-overflow-hidden ${isCategory3Expanded ? 'esg-max-h-[5000px] esg-opacity-100' : 'esg-max-h-0 esg-opacity-0'}`}
          >
            <div className="esg-p-4">
              <div className="esg-grid esg-grid-cols-1 esg-gap-4">
                <div className="md:esg-col-span-2 esg-flex esg-items-center">
                  ...
                  />
                  <label
                    htmlFor="scope3_co2e_relevant"
                    className="esg-text-gray-700lg esg-font-bold"
                  >
                    Vurdér, om Scope 3 CO₂e-udledning er relevant at oplyse om
                    for netop din virksomhed (obligatorisk hvis relevant):
                  </label>
                </div>
                {formData.scope3_co2e_relevant && (
                  <div className="md:esg-col-span-2">
                    <label
                      htmlFor="scope3_co2e_emissions"
                      className="esg-block esg-text-gray-700lg esg-font-bold esg-mb-2"
                    >
        ...
        <div className="esg-mb-8 esg-border esg-border-gray-200 esg-rounded-lg esg-shadow-sm">
          <div
            className="esg-p-4 esg-cursor-pointer esg-flex esg-justify-between esg-items-center esg-bg-gray-50 hover:esg-bg-gray-100 esg-rounded-t-lg"
            onClick={() => setIsCategory4Expanded(!isCategory4Expanded)}
          >
            <h3 className="esg-text-xl esg-font-semibold esg-text-gray-700">
              4. E-data: CO₂e-reduktionsmål og klimaomstilling (C3)
            </h3>
            <FaChevronDown
              className={`esg-ml-auto esg-transition-transform esg-duration-300 ${isCategory4Expanded ? 'esg-rotate-180' : ''}`}
            />
          </div>
          <div
            className={`esg-transition-[max-height,opacity] esg-duration-500 esg-ease-in-out esg-overflow-hidden ${isCategory4Expanded ? 'esg-max-h-[5000px] esg-opacity-100' : 'esg-max-h-0 esg-opacity-0'}`}
          >
            <div className="esg-p-4">
              <div className="esg-grid esg-grid-cols-1 md:esg-grid-cols-2 esg-gap-4">
                <div>
                  <label
                    htmlFor="co2e_reduction_target"
                    className="esg-block esg-text-gray-700lg esg-font-bold esg-mb-2"
                  >
                ...
                <div>
                  <label
                    htmlFor="co2e_reduction_actions"
                    className="esg-block esg-text-gray-700lg esg-font-bold esg-mb-2"
                  >
                    Liste med de handlinger, der skal bidrage til at nå
                    CO₂e-reduktionsmålene (obligatorisk hvis relevant):
                  </label>
                  <textarea
                ...
                <div>
                  <label
                    htmlFor="climate_transition_plan"
                    className="esg-block esg-text-gray-700lg esg-font-bold esg-mb-2"
                  >
                    Omstillingsplan for modvirkning af klimaforandringer
                    (obligatorisk hvis relevant):
                  </label>
                  <textarea
        ...
        <div className="esg-mb-8 esg-border esg-border-gray-200 esg-rounded-lg esg-shadow-sm">
          <div
            className="esg-p-4 esg-cursor-pointer esg-flex esg-justify-between esg-items-center esg-bg-gray-50 hover:esg-bg-gray-100 esg-rounded-t-lg"
            onClick={() => setIsCategory5Expanded(!isCategory5Expanded)}
          >
            <h3 className="esg-text-xl esg-font-semibold esg-text-gray-700">
              5. E-data: Klimarisici (C4)
            </h3>
            <FaChevronDown
              className={`esg-ml-auto esg-transition-transform esg-duration-300 ${isCategory5Expanded ? 'esg-rotate-180' : ''}`}
            />
          </div>
          <div
            className={`esg-transition-[max-height,opacity] esg-duration-500 esg-ease-in-out esg-overflow-hidden ${isCategory5Expanded ? 'esg-max-h-[5000px] esg-opacity-100' : 'esg-max-h-0 esg-opacity-0'}`}
          >
            <div className="esg-p-4">
              <div className="esg-grid esg-grid-cols-1 md:esg-grid-cols-2 lg:esg-grid-cols-5 esg-gap-4">
                <div>
                  <label
                    htmlFor="climate_risks_description"
                    className="esg-block esg-text-gray-700lg esg-font-bold esg-mb-2"
                  >
                    Beskrivelse af klimarelaterede risici og/eller
                    klimarelaterede omstillingsrisici (obligatorisk hvis
                    relevant):
                  </label>
                  <textarea
                ...
                <div>
                  <label
                    htmlFor="exposure_vulnerability"
                    className="esg-block esg-text-gray-700lg esg-font-bold esg-mb-2"
                  >
                    Eksponering og sårbarhed for virksomhedens aktiver,
                    aktiviteter og værdikæde (obligatorisk hvis relevant):
                  </label>
                  <textarea
                ...
                <div>
                  <label
                    htmlFor="climate_risks_time_horizon"
                    className="esg-block esg-text-gray-700lg esg-font-bold esg-mb-2"
                  >
                    Tidshorisont for, hvornår de klimarelaterede risici og
                    omstillingsrisici forventes at få negativ indflydelse på
                    virksomheden (obligatorisk hvis relevant):
                  </label>
                  <input
                    type="text"
                ...
                <div>
                  <div className="esg-flex esg-items-center">
                    ...
                    />
                    <label
                      htmlFor="climate_adaptation"
                      className="esg-block esg-text-gray-700lg esg-font-bold"
                    >
                ...
                <div>
                  <label
                    htmlFor="financial_impact_climate_risks"
                    className="esg-block esg-text-gray-700lg esg-font-bold esg-mb-2"
                  >
                    Potentiel negativ påvirkning på virksomhedens finansielle
                    præstation og forretningsdrift fra de oplistede klimarisici
                    (valgfri):
                  </label>
                  <textarea
        ...
        <div className="esg-mb-8 esg-border esg-border-gray-200 esg-rounded-lg esg-shadow-sm">
          <div
            className="esg-p-4 esg-cursor-pointer esg-flex esg-justify-between esg-items-center esg-bg-gray-50 hover:esg-bg-gray-100 esg-rounded-t-lg"
            onClick={() => setIsCategory6Expanded(!isCategory6Expanded)}
          >
            <h3 className="esg-text-xl esg-font-semibold esg-text-gray-700">
              6. S-data: Supplerende (generelle) oplysninger om arbejdsstyrken
              (C5)
            </h3>
            <FaChevronDown
              className={`esg-ml-auto esg-transition-transform esg-duration-300 ${isCategory6Expanded ? 'esg-rotate-180' : ''}`}
            />
          </div>
          <div
            className={`esg-transition-[max-height,opacity] esg-duration-500 esg-ease-in-out esg-overflow-hidden ${isCategory6Expanded ? 'esg-max-h-[5000px] esg-opacity-100' : 'esg-max-h-0 esg-opacity-0'}`}
          >
            <div className="esg-p-4">
              <div className="esg-grid esg-grid-cols-1 md:esg-grid-cols-3 esg-gap-4">
                <div>
                  <label
                    htmlFor="gender_management_ratio"
                    className="esg-block esg-text-gray-700lg esg-font-bold esg-mb-2"
                  >
                    Forholdet mellem kvinder og mænd på ledelsesniveau
                    (valgfri):
                  </label>
                  <input
                    type="text"
                ...
                <div>
                  <label
                    htmlFor="independent_workers"
                    className="esg-block esg-text-gray-700lg esg-font-bold esg-mb-2"
                  >
                    Antal selvstændige, som arbejder for din virksomhed
                    (valgfri):
                  </label>
                  <input
                    type="number"
        ...
        <div className="esg-mb-8 esg-border esg-border-gray-200 esg-rounded-lg esg-shadow-sm">
          <div
            className="esg-p-4 esg-cursor-pointer esg-flex esg-justify-between esg-items-center esg-bg-gray-50 hover:esg-bg-gray-100 esg-rounded-t-lg"
            onClick={() => setIsCategory7Expanded(!isCategory7Expanded)}
          >
            <h3 className="esg-text-xl esg-font-semibold esg-text-gray-700">
              7. S-data: Egen arbejdsstyrke: Menneskerettighedspolitikker og
              processer (C6)
            </h3>
            <FaChevronDown
              className={`esg-ml-auto esg-transition-transform esg-duration-300 ${isCategory7Expanded ? 'esg-rotate-180' : ''}`}
            />
          </div>
          <div
            className={`esg-transition-[max-height,opacity] esg-duration-500 esg-ease-in-out esg-overflow-hidden ${isCategory7Expanded ? 'esg-max-h-[5000px] esg-opacity-100' : 'esg-max-h-0 esg-opacity-0'}`}
          >
            <div className="esg-p-4">
              <div className="esg-grid esg-grid-cols-1 md:esg-grid-cols-2 esg-gap-4">
                <div>
                  <div className="esg-flex esg-items-center">
                    ...
                    />
                    <label
                      htmlFor="code_of_conduct_hr_policy"
                      className="esg-block esg-text-gray-700lg esg-font-bold"
                    >
                      Oplysning om ”code of conduct” eller
                      menneskerettighedspolitik for din virksomheds egen
                      arbejdsstyrke (JA/NEJ):
                    </label>
                  </div>
                </div>
                <div>
                  <div className="esg-flex esg-items-center">
                    ...
                    />
                    <label
                      htmlFor="grievance_mechanism"
                      className="esg-block esg-text-gray-700lg esg-font-bold"
                    >
                      Oplysning om klagemekanisme for virksomhedens egne ansatte
                      (JA/NEJ):
                    </label>
                  </div>
                </div>
        ...
        <div className="esg-mb-8 esg-border esg-border-gray-200 esg-rounded-lg esg-shadow-sm">
          <div
            className="esg-p-4 esg-cursor-pointer esg-flex esg-justify-between esg-items-center esg-bg-gray-50 hover:esg-bg-gray-100 esg-rounded-t-lg"
            onClick={() => setIsCategory8Expanded(!isCategory8Expanded)}
          >
            <h3 className="esg-text-xl esg-font-semibold esg-text-gray-700">
              8. S-data: Alvorlige negative menneskerettighedshændelser (egen
              arbejdsstyrke + værdikæde) (C7)
            </h3>
            <FaChevronDown
              className={`esg-ml-auto esg-transition-transform esg-duration-300 ${isCategory8Expanded ? 'esg-rotate-180' : ''}`}
            />
          </div>
          <div
            className={`esg-transition-[max-height,opacity] esg-duration-500 esg-ease-in-out esg-overflow-hidden ${isCategory8Expanded ? 'esg-max-h-[5000px] esg-opacity-100' : 'esg-max-h-0 esg-opacity-0'}`}
          >
            <div className="esg-p-4">
              <div className="esg-grid esg-grid-cols-1 md:esg-grid-cols-2 esg-gap-4">
                <div>
                  <label
                    htmlFor="confirmed_hr_incidents_own_workforce"
                    className="esg-block esg-text-gray-700lg esg-font-bold esg-mb-2"
                  >
                    Bekræftede negative menneskerettighedshændelser for din
                    virksomheds egen arbejdsstyrke:
                  </label>
                  <textarea
                ...
                <div>
                  <label
                    htmlFor="confirmed_hr_incidents_value_chain"
                    className="esg-block esg-text-gray-700lg esg-font-bold esg-mb-2"
                  >
                    Bekræftede negative menneskerettighedshændelser i din
                    virksomheds værdikæde (obligatorisk hvis relevant):
                  </label>
                  <textarea
        ...
        <div className="esg-mb-8 esg-border esg-border-gray-200 esg-rounded-lg esg-shadow-sm">
          <div
            className="esg-p-4 esg-cursor-pointer esg-flex esg-justify-between esg-items-center esg-bg-gray-50 hover:esg-bg-gray-100 esg-rounded-t-lg"
            onClick={() => setIsCategory9Expanded(!isCategory9Expanded)}
          >
            <h3 className="esg-text-xl esg-font-semibold esg-text-gray-700">
              9. G-data: Indtægter fra bestemte aktiviteter og udelukkelse fra
              EU-referencebenchmarks (C8)
            </h3>
            <FaChevronDown
              className={`esg-ml-auto esg-transition-transform esg-duration-300 ${isCategory9Expanded ? 'esg-rotate-180' : ''}`}
            />
          </div>
          <div
            className={`esg-transition-[max-height,opacity] esg-duration-500 esg-ease-in-out esg-overflow-hidden ${isCategory9Expanded ? 'esg-max-h-[5000px] esg-opacity-100' : 'esg-max-h-0 esg-opacity-0'}`}
          >
            <div className="esg-p-4">
              <div className="esg-grid esg-grid-cols-1 md:esg-grid-cols-2 esg-gap-4">
                <div>
                  <label
                    htmlFor="revenue_selected_sectors"
                    className="esg-block esg-text-gray-700lg esg-font-bold esg-mb-2"
                  >
                    Indtægter fra udvalgte sektorer (obligatorisk hvis
                    relevant):
                  </label>
                  <textarea
                ...
                <div>
                  <div className="esg-flex esg-items-center">
                    ...
                    />
                    <label
                      htmlFor="eu_benchmarks_exceedance"
                      className="esg-block esg-text-gray-700lg esg-font-bold"
                    >
                      Overskridelse af EU-benchmarks i overensstemmelse med
                      Parisaftalen (obligatorisk hvis relevant):
                    </label>
                  </div>
                </div>
              </div>
        ...
        <div className="esg-mb-8 esg-border esg-border-gray-200 esg-rounded-lg esg-shadow-sm">
          <div
            className="esg-p-4 esg-cursor-pointer esg-flex esg-justify-between esg-items-center esg-bg-gray-50 hover:esg-bg-gray-100 esg-rounded-t-lg"
            onClick={() => setIsCategory10Expanded(!isCategory10Expanded)}
          >
            <h3 className="esg-text-xl esg-font-semibold esg-text-gray-700">
              10. G-data: Kønsfordeling i øverste ledelsesorgan (C9)
            </h3>
            <FaChevronDown
              className={`esg-ml-auto esg-transition-transform esg-duration-300 ${isCategory10Expanded ? 'esg-rotate-180' : ''}`}
            />
          </div>
          <div
            className={`esg-transition-[max-height,opacity] esg-duration-500 esg-ease-in-out esg-overflow-hidden ${isCategory10Expanded ? 'esg-max-h-[5000px] esg-opacity-100' : 'esg-max-h-0 esg-opacity-0'}`}
          >
            <div className="esg-p-4">
              <div className="esg-grid esg-grid-cols-1 esg-gap-4">
                <div>
                  <label
                    htmlFor="gender_top_management_ratio"
                    className="esg-block esg-text-gray-700lg esg-font-bold esg-mb-2"
                  >
                    Forholdet mellem kvinder og mænd i det øverste ledelsesorgan
                    (obligatorisk hvis relevant):
                  </label>
                  <input
                    type="text"
